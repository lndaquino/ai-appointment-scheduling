    ...
    <Dialog.Portal>
      {isMounted && (
        <Dialog.Content
          ...
          className="fixed left-1/2 top-1/2 z-50 flex w-96 translate-x-[-50%] translate-y-[-50%] transform flex-col rounded-lg border border-indigo-500 bg-white outline-none xl:mx-8"
        >
          <Dialog.Close
            onClick={handleClose}
          ...
          <div className="flex flex-col items-center justify-center gap-6 p-4 pt-0">
            <h1 className="mb-2 text-center text-2xl font-bold text-indigo-600">
